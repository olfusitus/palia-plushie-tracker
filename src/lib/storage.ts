...
export type ResourceType = 'ore_silver' | 'ore_gold' | 'animal_chapaa' | 'animal_sernuk' | 'animal_muujin';
...
export function saveData(resourceType: ResourceType, data: ResourceEntry[]) {
	...
	localStorage.setItem(STORAGE_KEYS[resourceType], JSON.stringify(storedData));
}
