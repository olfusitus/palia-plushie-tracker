...
<div class="mb-8 flex w-full max-w-md flex-wrap justify-center gap-4">
    <div class="w-full flex items-center justify-center gap-4">
        ...
        <div class="sm:hidden relative">
            ...
            {#if showMobileMenu}
                <div class="absolute right-0 mt-2 w-48 rounded-lg bg-white shadow-lg z-50">
                    <button
    ...
    <div class="relative w-[45%]">
        <button
            ...
            class="w-full h-20 text-base sm:text-lg flex items-center justify-center rounded-lg bg-purple-500 text-white shadow-md transition-all duration-200 hover:bg-purple-400 active:scale-95"
        >
            RareDrop
        </button>
        {#if showRareDropMenu}
            <div class="absolute left-0 mt-2 w-48 rounded-lg bg-white shadow-lg z-40">
                {#each Object.keys(resource.sizes) as size}
                    <button
...
<div class="hidden mt-8 sm:flex flex-col items-center gap-4 text-center">
    <button
        on:click={downloadCSV}
