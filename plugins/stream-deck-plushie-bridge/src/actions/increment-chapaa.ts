...
const animalNames = [
    ...
    { animal: "animal_jaakcat", size: "small", name: "Jaakcat" },
    { animal: "animal_jaakcat", size: "medium", name: "Midnight\nJaakcat" },
    { animal: "animal_jaakcat", size: "large", name: "Hollow\nJaakcat" },
    { animal: "animal_highlands_sernuk", size: "small", name: "Hochland-\nSernuk" },
    { animal: "animal_highlands_sernuk", size: "medium", name: "Goldenes\nSernuk" },
    { animal: "animal_highlands_sernuk", size: "large", name: "Königliches\nSernuk" },
